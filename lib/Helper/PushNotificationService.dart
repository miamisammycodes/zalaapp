...
//           }
//           Provider.of<SettingProvider>(context, listen: false)
//               .setPrefrenceBool(ISFROMBACK, value: false);
//         }
//       }
//     });
...
//     setPrefrenceBool(ISFROMBACK, value: true);
...
//         context
//             .read<PushNotificationProvider>()
//             .getProduct(pay[1], 0, 0, list: true);
//       } else if (pay[0] == 'chat') {
...
//             final int index =
//                 saleList.indexWhere((element) => element.id == id);
//             Navigator.push(
//               context,
//               CupertinoPageRoute(

...
class StateSection extends State<SectionListScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final List<SectionModel> featuredSectionList =
      ...
      if (context.read<UserProvider>().userId != "") {
        try {
          ...
          if (int.parse(qty) < model.minOrderQuntity!) {
            String localqty = qty;
            localqty = model.minOrderQuntity.toString();
            setSnackbar(
        ...
        if (from == 1) {
          ...
          if (int.parse(MAX_ITEMS!) > cartCount) {
            ...
            print("maximum item-->${int.parse(MAX_ITEMS!)}");
          ...
          print("maximum cart --->${int.parse(qty)}");
          print("item counter --->${int.parse(model.itemsCounter!.last)}");
        ...
        apiBaseHelper.postAPICall(getSectionApi, parameter).then(
          (getdata) {
            ...
            if (!error) {
              ...
              print("sectionfirsttotal-->$total");
              print("admintotal-->${int.parse(data[0]["total"])}");
              total = int.parse(data[0]["total"]);
              print("totalitem--->$total");
              if (offset! < total!) {

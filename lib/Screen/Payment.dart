                        ...
                        Expanded(
                          child: SingleChildScrollView(
                            child: Column(
                              mainAxisSize: MainAxisSize.min,
                              children: [
                                if (context.read<UserProvider>().curBalance !=
                                        "0" &&
                                    (totalPrice > 0 || isUseWallet!))
                                        ...
                                        subtitle: Padding(
                                          ...
                                          child: Text(
                                            isUseWallet!
                                                ...
                                                : "${getTranslated(context, 'TOTAL_BAL')!} : ${getPriceFormat(context, balance)!}",
                                            style: TextStyle(
                                              fontSize: 15,
                                              color: Theme.of(context)
                                                  .colorScheme
              ...
              if (timeSlotList.isNotEmpty) {
                for (int i = 0; i < timeSlotList.length; i++) {
                  if (selectedDate != null) {
                    final DateTime today = DateTime.parse(startingDate!);
                    final DateTime date =
                        today.add(Duration(days: selectedDate!));
                    final DateTime cur = DateTime.now();
                    final DateTime tdDate =

  ...
  Widget _buildSendMessageTextField() {
    return Container(
      ...
      decoration: BoxDecoration(
        border: Border(
          bottom: BorderSide(color: Theme.of(context).colorScheme.primarytheme),
          top: BorderSide(
                            ...
                            children: [
                              ...
                              ...List.generate(
                                ...
                                if ((index - 1) >= 0) {
                                  ...
                                  final previousMessageDateTime =
                                      DateTime.parse(
                                    DateTime.parse(previousMessage.dateCreated!)
                                        .toLocal()
                                        .toString(),
                                  );
                                  if (previousMessage.fromId ==
                                          message.fromId &&
                                      TimeOfDay(
                                          ...
                                          TimeOfDay(
                                            hour: previousMessageDateTime.hour,
                                            minute:
                                                previousMessageDateTime.minute,
                                          ).format(context)) {
                                ...
                                return Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      if (message.mediaFiles?.isEmpty ?? true)
                                        const SizedBox()
                                      else
                                        Column(

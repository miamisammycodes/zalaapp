        ...
        apiBaseHelper.postAPICall(validatePromoApi, parameter).then(
          (getdata) {
            ...
            if (!error) {
              ...
              final String isCashback = data["is_cashback"].toString();
              final String cashbackAmount = data["final_discount"].toString();
              if (mounted) {
                print("iscash$isCashback");
                if (isCashback == "1") {
                  setSnackbar(
                    "Cashback of \$$cashbackAmount will be credited to your wallet after order completion.",
                    context,
                  );
                } else {
                  setSnackbar(
                      getTranslated(context, 'PROMO_SUCCESS')!, context);
                } 
              }

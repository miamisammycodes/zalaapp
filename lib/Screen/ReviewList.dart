...
class StateRate extends State<ReviewList> {
                      ...
                      Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            Text(
                                "$total ${getTranslated(context, "RATINGS")!}"),
                          ],
                        ),
                      ),
                      Expanded(
          ...
          (getdata) {
            ...
            if (!error) {
              ...
              if (offset < total) {
                ...
                // If this is a fresh load (offset == 0), clear the list first
                if (offset == 0) {
                  reviewList.clear();
                  // Reset user review data for fresh load
                  userComment = "";
                  userRating = "0.0";
                }
                ...
                // Update userComment and userRating after fetching review data
  ...
  // Helper method to update user review data
  void _updateUserReviewData() {

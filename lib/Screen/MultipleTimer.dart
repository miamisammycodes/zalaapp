...
class MultipleTimer extends StatefulWidget {
  ...
  @override
  MultipleTimerState createState() => MultipleTimerState();
}

class MultipleTimerState extends State<MultipleTimer>
      ...
      builder: (
        ...
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          if (snapshot.hasError) {
            ...
            final int time1 = snapshot.data;
            final Duration duration = Duration(seconds: time1);
            return time1 > 0
                ? widget.from == 1
                    ? Text(

...
class MobileOTPState extends State<VerifyOtp> with TickerProviderStateMixin {
  ...
  Future<void> getSingature() async {
    ...
    final listenForCode = SmsAutoFill().listenForCode;
    print("listenForCode$listenForCode");
  }
  ...
  //         verifyOtp,
  //         {"mobile": widget.mobileNumber, "otp": code},
  //       );
  //       if (!response['error']) {
  //         final SettingProvider settingsProvider =
  //             Provider.of<SettingProvider>(context, listen: false);
            ...
            onTap: () async {
              ...
              if (isFirebaseAuth == true) {
                ...
                if (getdata['error']) {
                  ...
                  setSnackbar(
                    getTranslated(context, "OTP Send Successfully")!,
                    context,
                  );
                }
              }

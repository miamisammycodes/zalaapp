...
class StatePreview extends State<ProductPreview> {
  ...
  void initState() {
    super.initState();
    final String? normalizedVideoType =
        widget.videoType?.toLowerCase().replaceAll(' ', '_');
    if (widget.from == true &&
    ...
    } else if (widget.from == true &&
        normalizedVideoType == "self_hosted" &&
        widget.video != null &&
        widget.video!.isNotEmpty) {
              ...
              PageView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  ...
                  if (index == 1 &&
                      ...
                      widget.video != null &&
                      widget.video!.isNotEmpty) {
                    if (widget.videoType == "youtube" && _controller != null) {
                      _controller!.reset();
                      return SafeArea(
                        child: YoutubePlayer(
                        ...
                        widget.video != null &&
                        widget.video!.contains("https://vimeo.com/")) {
                    ...
                    } else if (normalizedVideoType == "self_hosted" &&
                      ...
                      // Fallback UI if video type is unknown or controller is null
    ...
    return Padding(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color:
              Theme.of(context).colorScheme.primarytheme.withValues(alpha: 0.4),

...
class StateProfile extends State<MyProfile> with TickerProviderStateMixin {
              ...
              children: [
                ...
                Selector<UserProvider, String>(
                  ...
                  builder: (context, userMobile, child) {
                    mobileController = TextEditingController(text: userMobile);
                    return userMobile != ""
                        ? Text(
                            userMobile,
                            ...
                            children: [
                              Text(
                                ...
                                style: Theme.of(ctx)
                                    ...
                                    .copyWith(
                                      color:
                                          Theme.of(ctx).colorScheme.lightBlack,
                                    ),
                              ),
                              Text(
  ...
  Future<void> setUpdateUser(
    ...
    context.read<UserProvider>().setProgress(progress: false);
  }
  ...
  _getDrawer() {
    return ListView(
      ...
      children: <Widget>[
        ...
        if (context.read<UserProvider>().userId == "" || !refer)
          const SizedBox.shrink()
        else
          _getDrawerItem(
        ...
        _getDrawerItem(
          getTranslated(context, 'SHIPPING_PO_LBL')!,
          'assets/images/shipping_policy.svg',
        ),
        _getDrawerItem(
          getTranslated(context, 'RETURN_PO_LBL')!,
  ...
  Future<void> setDeleteSocialAcc() async {
    ...
    if (_isNetworkAvail) {
      try {
        apiBaseHelper.postAPICall(deleteSocialAccApi, {}).then(
          (getdata) {
  ...
  Future<void> setDeleteAcc() async {
    ...
    if (_isNetworkAvail) {
      try {
        ...
        apiBaseHelper.postAPICall(setDeleteAccApi, parameter).then(
          (getdata) {
            final bool error = getdata["error"];
            final String? msg = getdata["message"];
            if (!error) {
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            color: curTheme == index
                                ...
                                : Theme.of(ctx).colorScheme.white,
                            border: Border.all(
                              color: Theme.of(ctx).colorScheme.primarytheme,
                            ),
                          ),
                          child: Padding(
                            padding: const EdgeInsets.all(2.0),
                        ...
                        Padding(
                          ...
                          child: Text(
                            ...
                            style: Theme.of(ctx)
                                ...
                                .titleMedium!
                                .copyWith(
                                  color: Theme.of(ctx).colorScheme.lightBlack,
                                ),
                          ),
                        ),
                      ],
        ...
        actions: <Widget>[
          ...
          TextButton(
            ...
            onPressed: () async {
              ...
              settingProvider.clearUserSession(context);
              setSnackbar(
                  getTranslated(context, 'Logged_Out_Successfully')!, context);
            },
          ),
        ],
      ),
  ...
  Future<bool> validateAndSave(GlobalKey<FormState> key) async {
    ...
    if (form.validate()) {
      ...
      context.read<UserProvider>().setProgress(progress: true);

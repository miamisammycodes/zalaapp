...
class LoginPageState extends State<SetPass> with TickerProviderStateMixin {
  ...
  Future<void> getResetPass() async {
    try {
      final data = {MOBILENO: widget.mobileNumber, NEWPASS: password};
      apiBaseHelper.postAPICall(getResetPassApi, data).then(
        (getdata) async {

...
class SignUpPageState extends State<SignUp> with TickerProviderStateMixin {
  ...
  FocusNode? referFocus = FocusNode();
  ...
  Future<void> getRegisterUser() async {
    try {
      ...
      apiBaseHelper.postAPICall(getUserSignUpApi, data).then(
        (getdata) async {
          ...
          if (!error) {
            ...
            Navigator.of(context).pushAndRemoveUntil(
              MaterialPageRoute(
                builder: (context) {
                  Dashboard.dashboardScreenKey = GlobalKey<HomePageStates>();
                  return Dashboard(
  ...
  Widget registerTxt() {
    return Padding(
      ...
      child: Align(
        ...
        child: Text(
          getTranslated(context, 'USER_REGISTER_DETAILS')!,
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          Text(
            getTranslated(context, 'SHOW_PASSWORD')!,
            style: TextStyle(
              color: Theme.of(context).colorScheme.fontColor,
              fontWeight: FontWeight.normal,
            ),
  ...
  Future<void> generateReferral() async {
    ...
    try {
      ...
      apiBaseHelper.postAPICall(validateReferalApi, data).then(
        (getdata) {
          final bool error = getdata["error"];
          if (!error) {
            referCode = refer;

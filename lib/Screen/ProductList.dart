...
class StateProduct extends State<ProductListScreen>
        ...
        child: Padding(
          ...
          child: Consumer<CartProvider>(
            builder: (context, data, child) {
              final SectionModel? tempId = data.cartList.firstWhereOrNull(
                (cp) =>
                    cp.id == model.id &&
              ...
              return Stack(
                ...
                children: [
                  ...
                  if (cartBtnList)
                    _controller[index].text == "0" && model.availability != "0"
  ...
  Widget productItem(int index, {required bool pad}) {
    if (index < productList.length) {
      final Product model = productList[index];
      totalProduct = model.total;
      if (_controller.length < index + 1) {
                ...
                Container(
                  ...
                  child: IconButton(
                    ...
                    onPressed: () {
                      if (!_hasSpeech) {
                        initSpeechState();
                      } else if (!_hasSpeech || speech.isListening) {
                        startListening();
                      }
                    },
                  ),
                        ...
                        ? ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              if (index == 0) {
                                ...
                                final List<String> att = filterList[index]
                                        ['attribute_values']!
                                    .split(',');
                                final List<String> attSType = filterList[index]
                                        ['swatche_type']
                                    .split(',');
                                final List<String> attSValue = filterList[index]
                                        ['swatche_value']
                                    .split(',');

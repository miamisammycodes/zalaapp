...
class SettingProvider {
  ...
  final String _supportedLocales = '';
  ...
  Future<void> setPrefrenceBool(String key, {required bool value}) async {
    _sharedPreferences.setBool(key, value);
  }

  setPrefrenceList(String key, String query) async {
    final List<String> valueList = await getPrefrenceList(key);
  ...
  Future<void> clearUserSession(BuildContext context) async {
    final String? theme = await getPrefrence(APP_THEME);
    ...
    setPrefrenceBool(ISFIRSTTIME, value: true);

...
class ProductDetailProvider extends ChangeNotifier {
  ...
  setReviewLoading({required bool loading}) {
    _moreProductLoading = loading;
    notifyListeners();
  }

  setProductLoading({required bool loading}) {
    _moreProductLoading = loading;
    notifyListeners();
  }

  setProNotiLoading({required bool loading}) {
    _moreProNotiLoading = loading;
    notifyListeners();
  }

  setProGetData({required bool loading}) {
    _moreProductLoading = loading;
    notifyListeners();
  }

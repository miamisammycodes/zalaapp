...
class Product {
  ...
  List<ProductVarient>? prVarientList;
  ...
  factory Product.fromJson(Map<String, dynamic> json) {
    ...
    List<ProductVarient> varientList = [];
    if (vList == null || vList.isEmpty) {
      varientList = [];
    } else {
      varientList = (json[PRODUCT_VARIENT] as List)
          .map((data) => ProductVarient.fromJson(data))
          .toList();
    }
...
class ProductVarient {
  ...
  factory ProductVarient.fromJson(Map<String, dynamic> json) {

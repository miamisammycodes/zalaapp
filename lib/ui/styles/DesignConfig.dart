  ...
  scrollBottomBarController.addListener(() {
    if (scrollBottomBarController.position.userScrollDirection ==
      ...
      if (!context.read<HomeProvider>().animationController.isAnimating) {
        ...
        context.read<HomeProvider>().showBars(value: false);
      }
    } else {
      if (!context.read<HomeProvider>().animationController.isAnimating) {
...
getThemeColor(BuildContext context) {
  ...
  final applicationBrightness = Theme.of(context).brightness;
...
Widget showCircularProgress(BuildContext context, Color color,
